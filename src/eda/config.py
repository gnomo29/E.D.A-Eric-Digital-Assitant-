...
EDA_SPOTIFY_PREFER_OFFICIAL = _env_bool("EDA_SPOTIFY_PREFER_OFFICIAL", True)
EDA_COMMAND_CONFIDENCE_THRESHOLD = _env_float("EDA_COMMAND_CONFIDENCE_THRESHOLD", 0.78)
EDA_CONVERSATION_STYLE = _env_str("EDA_CONVERSATION_STYLE", "formal").lower()
EDA_RELEASE_OLLAMA_MEMORY = _env_bool("EDA_RELEASE_OLLAMA_MEMORY", True)
EDA_OFFLINE_MODE = _env_bool("EDA_OFFLINE_MODE", False)
